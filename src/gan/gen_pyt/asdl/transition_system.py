...
class GenEngTokenAction(GenTokenAction):
    def __init__(self, token):
        self.token = token

    def is_stop_signal(self):
        return self.token == '<eos>'
...
class TransitionSystem(object):
    ...
    def get_class_by_lang(lang):
        if lang == 'python':
            ...
            from .lang.eng.eng_transition_system import EnglishTransitionSystem
            return EnglishTransitionSystem
        elif lang == 'python3':
