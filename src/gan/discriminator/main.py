...
def main():
    ...
    if not os.path.isfile(sick_vocab_file):
        ...
        token_files_b = [os.path.join(split, 'b.toks') for split in dirs]
        token_files_a = [os.path.join(split, 'a.toks') for split in dirs]
    ...
    if os.path.isfile(emb_file):
        ...
        for word in vocab.labelToIdx.keys():
            if glove_vocab.getIndex(word.lower()):
                emb[vocab.getIndex(word)] = glove_emb[glove_vocab.getIndex(word.lower())]
